...
export const usage = `acp — Agent Coordination Protocol CLI
  ...
  acp workspace list
  acp session init --worker <id> --name <n> [--kind <k>] [--vendor <v>] [--capabilities <csv>] [--permissions <csv>] [--workspace <id[,id...]> ...]
  acp worker list
  ...
  acp work cancel-subtree <work_id>
  ...
  acp lease list --workspace <id> [--holder <holder>]
  ...
  acp events list --workspace <id> --tail <n> [--type <event_type>]
