...
- 2026-07-13 · v1.1.0 release contract · required the canonical README status
  ...
  documentation-first grill before implementation · risk LOW ·
...
- 2026-07-13 · version bump policy · accepted
  ...
  refusal, interrupted tag-flow double-bump prevention, affected-path rollback
  reporting, rollback-capable multi-file writes, and post-commit-only release
  tagging; specified the operator surface
...
- 2026-07-12 · native RPC handler test mirrors · distilled direct artifact,
  ...
  precedence; mirror debt is now 11 RPC/protocol tests with no production gaps
  or orphans · validation: exact bidirectional path audit + repository-pinned
...
- 2026-07-12 · core domain test mirrors · distilled artifact ownership/bounds,
  ...
  domain MOCs and service backlinks; mirror debt is now 40 tests with no
  production gaps or orphans · validation: exact bidirectional path audit +
  repository-pinned Prettier · risk LOW · [[source-mirror-2026-07-10]]
