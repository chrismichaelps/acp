...
export const Review: Schema.Struct<{
  id: ReviewId; work_id: WorkId; requested_by: WorkerId
  reviewer: optionalWith<WorkerId, Option>; state: ReviewState
  requirements: Schema.Array<string>; created_at: Timestamp
}>
export const RequestReviewPayload: Schema.Struct<{
  work_id; requested_by; reviewer?; requirements }>
