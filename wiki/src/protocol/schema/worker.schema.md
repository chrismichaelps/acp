...
### Signatures
```typescript
export const Capability: Schema.Literal<[ // declared capability flags
  "can_edit_files","can_run_commands","can_create_prs","can_review",
  "supports_checkpoints","supports_leases"]>
export const Worker: Schema.Struct<{
  id: WorkerId; name: NonEmptyString; kind: WorkerKind; vendor: optional<string>
  status: WorkerStatus; capabilities: Schema.Array<Capability>
}>
