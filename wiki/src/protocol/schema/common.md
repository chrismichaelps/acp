...
export const WorkState: Schema.Literal<[…9 states…]>
...
## Algorithm
Each enum is `Schema.Literal(...members)` matching the exact spec §10 lists. The
literal unions are the authoritative state vocabularies; services import these,
...
## Referenced by
[[work-unit.schema]] · [[worker.schema]] · [[lease.schema]] · [[src/_MOC]]
