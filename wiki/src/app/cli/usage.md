...
session bootstrap, workspace/work flows, lease lifecycle, artifact evidence
commands including pull request URL registration, resume reads, review actions,
event replay, and event streaming.
