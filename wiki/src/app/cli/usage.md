...
session bootstrap, workspace/work flows, lease lifecycle and lease readback,
artifact evidence commands including pull request URL registration, resume
reads, review actions, event replay, and event streaming.
